...
class YubiPrivateKeyOps : PrivateKeyOps {
    ...
    private val DEFAULT_PIN: CharArray = "123456".toCharArray();
    ...
    override fun sign(data: ByteArray): ByteArray? {
        // TODO: Establish connection to YubiKey
    ...
    private fun loadPrivateKey(slot: Slot): PrivateKey? {
        try {
            ...
            keyStore.load(null)
            val privateKey = keyStore.getKey(Slot.AUTHENTICATION.stringAlias, DEFAULT_PIN) as PrivateKey
            return privateKey
        } catch (e: Exception) {
            Log.e("YubiPrivateKeyOps", "Error loading signing key: ${e.message}")
            return null
        }
    }
